...
include 'Connect.php';
$ids=$_GET['id'];
$sql="SELECT * FROM product_cat WHERE pro_id='$ids' ";
...
<body>
 ...
 เพิ่มจำนวนสินค้า
        ...
        <form name="form1" method="POST" action="update_addStock.php">
            <div class="mt-3 mb-3">
            ...
            <div class="mt-3 mb-3">
                ...
                <input type="member" name="pnum" class="form-control" required>
            </div>
            <input type="submit" name="submit" class="btn btn-outline-success" value="Submit">
            <a href="indexcat.php" class="btn btn-outline-danger">Cancel</a>
        </form>
        </div>
    </div>
    </div>
